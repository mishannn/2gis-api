...
declare type ItemsResponseResultItem = AdmDivItem | BuildingItem | GateItem | ProjectItem | StationEntranceItem | StreetItem | AttractionItem | CoordinatesItem | ParkingItem | RoadItem | StationItem | BranchItem | CrossRoadItem | PoiItem | RouteItem | StationPlatformItem;
