 ...
 * Диапазон значений.
 */
export default interface ItemsResponseResultFiltersRange {
    /**
     * Минимальное значение атрибута, имеющееся в выборке.
     */
    min: number;
    /**
     * Максимальное значение атрибута, имеющееся в выборке.
     */
    max: number;
}
