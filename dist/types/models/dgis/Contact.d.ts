export declare type ContactType = 'email' | 'website' | 'phone' | 'fax' | 'icq' | 'jabber' | 'skype' | 'vkontakte' | 'twitter' | 'instagram' | 'facebook' | 'pobox' | 'youtube' | 'odnoklassniki' | 'googleplus' | 'linkedin' | 'pinterest';
