 ...
 */
import ItemsResponseResultFiltersRange from './ItemsResponseResultFiltersRange';

export default interface ItemsResponseResultFiltersAttributes {
  /**
   * Локализованное название атрибута.
   */
  label?: string;
  /**
   * Ключ фильтрующего атрибута.
   */
  tag: string;
  /**
   * Тип атрибута.
   */
  type?: string;
  range?: ItemsResponseResultFiltersRange;
}
